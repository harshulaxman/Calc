...
<head>
    ...
    <style>
        ...
        .button {
            ...
            margin-right: 750px;
            padding: 40px;
            background-color: rgb(182, 130, 245);
            color: white;
            border:5px solid rgb(219, 88, 231)
        }

        .button input[type="button"] {
            background-color:rgb(208, 102, 187);
            height: 50px;
            width: 50px;
            margin: 0 2px;
            border: 3px solid rgb(148, 39, 145);
        }
    </style>
</head>

<body style="background-color: rgb(156, 214, 228);">
        <h1 align="center" style="color:rgb(16, 14, 10);">CALCULATOR</h1><br>
        <h2 align="center" style="color:rgb(71, 24, 212);">HARSSHITHA LAKSHMANAN(212223230075)</h2><br>
        <div class="button">
            <center>
            
            <input type="text" id="t1" style="width:290px; height:60px;"><br><br>
...
```
## OUTPUT:
![alt text](<Screenshot 2024-05-05 115610.png>)
![alt text](<Screenshot 2024-05-05 115624.png>)
## RESULT:
